...
import type { PaperPreset, ShaderPreset, CompositePreset } from "../presets/types";
...
export function VariantSelector({ preset }: { preset: PaperPreset | ShaderPreset | CompositePreset }) {
